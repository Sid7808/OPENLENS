...
export default function LoginForm() {
    ...
    // React Concept: Boolean State for UI toggling 
    ...
    return (
        <div className="login-form-wrapper">
            <div className="login-brand-header">
                <img src={Logo} alt="OpenLens Logo" className="login-logo" />
            </div>

            <h1 className="login-heading">Sign in to OpenLens</h1>
            ...
            <form className="login-form" onSubmit={handleLogin}>
                ...
                <div className="input-group">
                    ...
                    <div className="password-input-wrapper">
                        <input
                            id="password"
                            // React Concept: Conditional Rendering of attributes
            ...
            <div className="login-footer">
                &copy; 2026 OpenLens. All rights reserved.
            </div>
        </div>
    );
}
